...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			...
			' title="' + prevText + '"><i class="fa fa-chevron-left fa-lg"></i></a>' :
			(hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+ prevText +'"><i class="fa fa-chevron-left fa-lg"></i></a>'));
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			...
			' title="' + nextText + '"><i class="fa fa-chevron-right fa-lg"></i></a>' :
			(hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+ nextText + '"><i class="fa fa-chevron-right fa-lg"></i></a>'));
