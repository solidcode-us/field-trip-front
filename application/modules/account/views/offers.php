...
<div class="container">
	<div class="full-page-wrap"><div class="signup-div"><!-- MIDDLE AREA -->
            <h3 class="text-center"  style="margin-top:20px;float: left;width: 80%;">Offers</h3>
            <h3 class="right" style="margin-top:20px;float: left;width: 10%;"><a href="/account/logout">Logout</a></h3>
            ...
            <div class="form-horizontal" style="margin:25px 0 0 220px;">
                ...
                <div id="infoMessage" style="font-size:20px;padding:120px 0 0 250px;;">Comming Soon...</div>
            <style>
