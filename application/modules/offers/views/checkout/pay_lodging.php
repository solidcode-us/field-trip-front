<div id="wants-nav" class="right-nav wide">
    ...
    <div class="padded">
      <ul class="info-bar dis-block" style="padding:15px;margin:15px 0;border-top:1px solid #dedede;border-bottom:1px solid #dedede;">
        <li><i class="fa fa-calendar"></i> Fri. Jan 25 - Mon. Feb 10, 2015</li>   
        <li><i class="fa fa-users"></i> 5</li>
    ...
    <p class="text-center dis-block padded" style="margin:20px 0 0;">This payment transacts in <strong>$USD</strong>. Your total charge is <strong>$12,793</strong>.</p>
