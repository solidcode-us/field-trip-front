...
<ul class="menu-list no-icons input-fields">
  <li>
	...
	<span class="value">
	<input type="text" placeholder="Jane Tripper" id="name" autocomplete="off">
  ...
  <li>
    <span class="title">Birthday</span> <span class="value">
	 ...
	 <?php  for($y=2015;  $y > 1940; $y--) {?>
		...
		<div id="error_dob_month" style="display: none;padding-left:150px;" class="errUser">Please select month.</div>
...
<ul class="menu-list no-icons input-fields">
  <li>
	...
	<span class="value">
		<input type="email" required=required placeholder="example@field-trip.com" id="email" autocomplete="off">
		 <div id="error_email" style="display: none;" class="errUser">Please enter email address.</div>
	</span>
  </li>
  <li>
    <span class="title">Phone</span> <span class="value"><input type="tel" placeholder="(305) 123-1234" id="phone"></span>
  </li>
  <li>
