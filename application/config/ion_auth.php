...
|
*/
$config['collections']['users']          = 'members';
 ...
 */
$config['site_title']                 = "Field-Trip Team";       // Site Title, example.com
$config['admin_email']                = "admin@field-trip.com"; // Admin Email, admin@example.com
...
$config['email_config'] = array(
		...
		'smtp_port' => 587,
		'smtp_user' => 'info@field-trip.com', // change it to yours
		'smtp_pass' => 'ZQlVaPlj5CsYD_WrDIAISQ', // change it to yours 
		'mailtype' => 'html',
		'charset' => 'utf-8',
		'wordwrap' => TRUE 
);
