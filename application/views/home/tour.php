...
<div class="sec-block exp" style="padding-top:5px;"><div class="container">    
    <section class="tab-content">
      ...
      <div class="tab-pane fade in active" id="info">
        <!-- OVERVIEW -->
        <?php $this->load->view('home/tab/info_tour.php'); ?>
        <!-- OVERVIEW END -->
      
        <!-- BOOK NOW -->
        <?php $this->load->view('home/tab/book_tour.php'); ?>
        <!-- BOOK NOW END -->
      </div>
      <!-- INFO END -->
      ...
      <div class="tab-pane fade" id="customize">
		  <?php $this->load->view('home/tab/customize_tour.php'); ?>
      </div>
      <!-- CUSTOMIZE END -->
    </section>
</div></div>
...
<!-- EXP DETAILS -->
<?php $this->load->view('home/tab/tour_details.php'); ?>
<!-- EXP DETAILS END -->
