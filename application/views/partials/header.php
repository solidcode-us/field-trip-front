...
<?php	$notificationInfo = $this->user_model->get_user_notification_flag($this->user->id);?>
  <ul class="main-nav-menus">
    ...
    <li><a title="Notification" href="<?php echo base_url(); ?>user/inbox"><img src="<?php echo base_url(); ?>public/assets/images/icons/inbox.png"/><?php echo (!empty($notificationInfo->noOfNotif)) ? '<span class="badge">'. $notificationInfo->noOfNotif.'</span>' : ""; ?></a></li>
