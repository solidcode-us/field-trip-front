...
<header class="main-white-nav">
  <div class="container"><span class="ft-logo-btn wide" style="background-image:url(<?php echo base_url(); ?>public/assets/images/logo2.png);"></span></div>
</header>
...
<section class="bot-nav">
    ...
    <section class="steps-block step-6">
          ...
          <a class="btn btn-blue next" href="<?php echo base_url(); ?>offers">Done!</a>
    </section>
</section>
